...
public class database {
    ...
    public static String [] grocery= {"banana", "apple", "orange", "bread" };
    ...
    public static HashMap<String, Double> Customer=new HashMap<String, Double>();
    static{
                Customer.put("6308131234", 30.0);
